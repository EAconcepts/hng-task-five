  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col">
        <section className="w-full flex gap-x-2 px-[2.5rem] divide-x-2 pt-10">
          <div className="w-full flex justify-center px-[2.5rem]">
            <div className="w-full flex flex-col gap-y-[4.5rem] ">
              <h1 className="font-sora font-[700] text-[2.813rem] leading-[3.544rem] text-[#141414]">
                Your Video is ready!
              </h1>
              <div className="flex flex-col">
                <p className="font-sora font-[500] text-[1rem] leading-[1.26rem] text-[#727272]">
                  Name
                </p>
              ...
              <form
                className="flex justify-between rounded-[1rem] bg-[#E7E7ED] bg-opacity-[80%] px-[0.75rem] py-[1.5rem]"
              ...
              >
                ...
                <input
                  ...
                  className=" w-full leading-[1.319rem] font-workSans font-[400] text-[1.125rem] text-[#434343] text-opacity-[80%] bg-transparent active:border-none focus-within:outline-none"
                />
                <button className="text-[1rem leadin[1.5rem] text-white bg-[#434343] py-[0.625rem] px-[1.125rem] rounded-[0.5rem]">
                  Send
                </button>
                {/* </div> */}
              </form>
              <div className="flex flex-col">
                <h4 className="font-sora font-[600] text-[1.25rem] text-[#141414] leading-[1.575rem] mb-2">
                  Video Url
                </h4>
                <div className="flex items-center justify-between bg-[#9292922f] rounded-[1rem] border-[#929292] border-[0.5px] p-[0.75rem]">
                  <Link to="https://www.helpmeout/Untitled_Video_20232509">
                    https://www.helpmeout/Untitled_Video_20232509
                  </Link>
                  <button className="flex py-[0.5rem] px-[1.125rem] border border-[#120B48] rounded-[0.5rem] gap-x-[0.5rem]">
                    <svg
                      width="21"
                      height="20"
                      viewBox="0 0 21 20"
              ...
              <div className="flex flex-col">
                <p className="font-sora font-[600] text-[1rem] text-[#08051E] leading-[1.26rem] mb-2">
                  Share your video
                </p>
                <div className="flex gap-x-[1rem]">
                  <button className="flex gap-x-[0.5rem] py-[0.75rem] px-[1rem] border rounded-[0.375rem] border-[#0A0628]">
                    <svg
                      width="25"
                      height="24"
                      viewBox="0 0 25 24"
                    ...
                    <span className="font-inter font-[500] text-[1rem] leading-[1.5rem] text-[#08051E]">
                      Facebook
                    </span>
                  </button>
                  <button className="flex gap-x-[0.5rem] py-[0.75rem] px-[1rem] border rounded-[0.375rem] border-[#0A0628]">
          ...
          <aside className="w-full flex flex-col px-[2.5rem]">
            <div className="flex flex-col border rounded-[0.5rem] border-[#413C6D]">
              ...
              <div className="flex justify-between gap-x-[0.5rem] px-[2.5rem] py-2 border-t">
                ...
                <div className="flex gap-x-[2.5rem]">
                  <button className="flex flex-col items-center gap-y-[0.25rem]">
                    <svg
                      width="25"
                      height="24"
                      viewBox="0 0 25 24"
                    ...
                    >
                      <path
                        d="M12.4697 22.25C6.82557 22.25 2.21973 17.6536 2.21973 12C2.21973 6.34645 6.82557 1.75 12.4697 1.75C18.1139 1.75 22.7197 6.34645 22.7197 12C22.7197 17.6539 18.1236 22.25 12.4697 22.25ZM12.4697 2.25C7.09358 2.25 2.71973 6.62386 2.71973 12C2.71973 17.3761 7.09358 21.75 12.4697 21.75C17.8459 21.75 22.2197 17.3761 22.2197 12C22.2197 6.62386 17.8459 2.25 12.4697 2.25Z"
                        fill="#292D32"
                        stroke="#141414"
                      />
                      <path
                        d="M12.6305 8.45315L12.6307 8.45329L15.5305 10.1232C16.5362 10.703 17.0002 11.4603 17.0002 12.23C17.0002 12.9906 16.5352 13.7575 15.5305 14.3368L12.6307 16.0067L12.6307 16.0066L12.624 16.0106C12.0688 16.342 11.5263 16.49 11.0602 16.49C10.7055 16.49 10.3716 16.4018 10.0793 16.2364C9.41774 15.8506 8.99023 15.067 8.99023 13.91V10.56C8.99023 9.39798 9.41123 8.61615 10.0715 8.23225C10.7307 7.84904 11.6231 7.87234 12.6305 8.45315ZM12.386 15.5854L12.386 15.5854L12.3898 15.5833L15.2898 13.9133L15.2913 13.9124C15.9607 13.5237 16.5102 12.9429 16.5102 12.24C16.5102 11.5346 15.9466 10.9543 15.2944 10.5694L15.2944 10.5694L15.2898 10.5667L12.3935 8.89887C11.949 8.63282 11.4907 8.46999 11.0602 8.46999C10.8152 8.46999 10.5507 8.52299 10.3241 8.66055C9.71109 9.01933 9.49023 9.78674 9.49023 10.56V13.91C9.49023 14.6664 9.70794 15.4543 10.3315 15.8038C10.9435 16.1627 11.7305 15.9554 12.386 15.5854Z"
                        fill="#292D32"
                        stroke="#141414"
                      />
                    </svg>
                    <p className="text-[0.75rem] text-[#141414] font-workSans font-[500] leading-[0.88rem]">
                      Play
                    </p>
                  </button>
                  <button className="flex flex-col items-center gap-y-[0.25rem]">
            ...
            <div className="flex flex-col mt-12">
              <h3 className="font-sora font-[600] text-[1.5rem]">Transcript</h3>
              <select className="w-fit text-[1rem] text-[#9D9D9D]">
                <option value="English" selected disabled>
                  English
                </option>
              </select>
              <div className="flex flex-col mt-6 gap-y-2">
                <div className="flex gap-x-[2rem] text-[1rem]">
                  <p className=" font-workSans font-[400] text-[#9D9D9D]">
                    0.01
                  </p>
                  <p className="font-inter font-[500]">
        ...
        <div className="w-full flex  flex-col items-center mt-14 gap-y-[2.5rem]">
          <p className="font-sora font-[600] text-[1.5rem] leading-[1.89rem]">
            To ensure the availability and privacy of your video, we recommend
            saving it to your account.
          </p>
          <div className="bg-[#120B48] rounded-[0.5rem]">
            <button className="py-[1rem] px-[2rem] text-[#F9F9FF] text-[1rem] leading-[1.173] font-workSans font-[500]">
              Save Video
            </button>
          </div>
          <div className="flex space-x-1 font-sora font-[600] text-[1.5rem] ">
            <p className="text-[#7E7E7E]">Don't have an account?</p>
            <Link to="/login" className="text-[#120B48] underline">
              Create account
            </Link>
          </div>
        </div>
